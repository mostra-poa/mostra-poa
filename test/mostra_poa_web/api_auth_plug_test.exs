defmodule MostraPoaWeb.APIAuthPlugTest do
  use MostraPoaWeb.ConnCase
  doctest MostraPoaWeb.APIAuthPlug

  alias MostraPoaWeb.{APIAuthPlug, Endpoint}
  alias MostraPoa.{Repo, Users.User}
  alias Plug.Conn

  @pow_config [otp_app: :mostra_poa]
