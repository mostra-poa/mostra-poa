defmodule MostraPoaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MostraPoaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MostraPoaWeb.Gettext, "errors", msg, opts)
    end
  end
